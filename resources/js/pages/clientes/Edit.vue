...
const form = useForm({
    ...
    endereco: {
        linha1: props.cliente.endereco?.linha1 || '',
        linha2: props.cliente.endereco?.linha2 || '',
        cidade: props.cliente.endereco?.cidade || '',
        estado: props.cliente.endereco?.estado || '',
        cep: props.cliente.endereco?.cep || '',
        pais: props.cliente.endereco?.pais || '',
    },
});
        ...
        <div class="flex flex-col min-h-[calc(100vh-64px)] w-full bg-background p-0">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 px-8 pt-8 pb-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-[#3B82F6] dark:text-[#60A5FA]">Editar Cliente</h1>
                        <p class="text-[#64748B] dark:text-[#CBD5E1]">Edite as informações do cliente</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <InputText id="observacoes" v-model="form.observacoes" placeholder="Observações sobre o cliente" class="w-full" />
