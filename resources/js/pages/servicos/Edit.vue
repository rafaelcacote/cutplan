...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar Serviço', href: `/servicos/${props.servico.id}/edit` },
];
const form = useForm({
    nome: props.servico.nome,
    descricao: props.servico.descricao || '',
    preco_base: props.servico.preco_base || '',
    categoria: props.servico.categoria || '',
    ativo: props.servico.ativo,
});
const submit = () => {
    form.put(route('servicos.update', props.servico.id));
};
</script>
<template>
        ...
        <div class="flex flex-col min-h-[calc(100vh-64px)] w-full bg-background p-0">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 px-8 pt-8 pb-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-[#3B82F6] dark:text-[#60A5FA]">Editar Serviço</h1>
                        <p class="text-[#64748B] dark:text-[#CBD5E1]">Edite as informações do serviço</p>
                    </div>
                </div>
            </div>
            <form @submit.prevent="submit" class="flex-1 px-8 pb-8">
                <Card class="p-8">
                    <CardHeader>
                        ...
                        <CardDescription>Edite os dados do serviço abaixo</CardDescription>
                    </CardHeader>
                    <CardContent>
