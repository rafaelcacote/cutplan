...
import { Box, Shield, Truck, Users, Briefcase, Layers, Folder, Settings } from 'lucide-vue-next';
...
<template>
    <SidebarGroup class="mt-4 px-2 py-0">
        ...
        >
            ...
            <svg :class="['transition-transform', cadastrosOpen ? 'rotate-90' : '']" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"/></svg>
        </SidebarMenuSubButton>
    ...
    <SidebarGroup class="mt-4 px-2 py-0">
        ...
        >
            ...
            <svg :class="['transition-transform', configOpen ? 'rotate-90' : '']" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"/></svg>
        </SidebarMenuSubButton>
